  ...
  return (
    <div className='dark:bg-dark bg-blue-50 sm:min-h-[600px] sm:grid sm:place-items-center mt-4 '>
     <div className="container">
      <div className="flex flex-col justify-between items-center  md:flex md:flex-row md:justify-between">
       <div className="">
       <img src={car1} alt="" />
       </div>
      ...
      <p className='p-4 font-serif font-medium text-wrap'> Our websites simplify travel planning with easy bookings, competitive rates, and a wide selection of vehicles. Enhancing flexibility and choice in transportation,These services cater to both leisure and business travelers, streamlining the process of securing reliable transportation..</p>
